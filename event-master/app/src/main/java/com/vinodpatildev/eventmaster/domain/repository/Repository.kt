...
interface Repository {
    ...
    suspend fun forgetStudentPassword(username:String, email:String): Resource<Boolean>
    suspend fun resetStudentPassword(email:String, password:String, otp:String): Resource<Boolean>
